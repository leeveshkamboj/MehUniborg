...
class Config(object):
    ...
    PRIVATE_CHANNEL_BOT_API_ID = int(os.environ.get("PRIVATE_GROUP_BOT_API_ID", -100123456789))
    ...
    F_BAN_LOGGER_GROUP = int(os.environ.get("F_BAN_LOGGER_GROUP", -100123456789))
