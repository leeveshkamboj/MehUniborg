...
async def _(event):
  ...
  if event.reply_to_msg_id:
    ...
    if previous_message.sticker or previous_message.poll:
        ...
        return
    if previous_message.gif or previous_message.document or previous_message.audio or previous_message.voice or previous_message.video or previous_message.video_note or previous_message.contact or previous_message.game or  or previous_message.geo or previous_message.invoice:          # Written by @HeisenbergTheDanger
